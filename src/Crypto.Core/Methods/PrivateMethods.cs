...
public class PrivateMethods
{
    ...
    public PrivateMethods(string apiPublicKey, string apiPrivateKey, bool checkCertificate = true)
    {
        // TLS 1.2+ Supported 
        ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;

        utilities = new Utilities(apiPublicKey, apiPrivateKey, checkCertificate);
    }
    ...
    public string GetAccounts()
    {
        ...
        Task<string> result = Task.Run(async () => await utilities.MakeRequest(HttpRequestMethods.GET, endpoint));
    ...
    //     return utilities.MakeRequest(HttpRequestMethods.POST, endpoint, string.Empty, postBody);
    // }
    ...
    //     return utilities.MakeRequest(HttpRequestMethods.POST, endpoint);
    // }
    ...
    //     return utilities.MakeRequest(HttpRequestMethods.POST, endpoint, postUrl);
    // }
    ...
    //     return utilities.MakeRequest(HttpRequestMethods.GET, endpoint);
    // }
    ...
    //     return utilities.MakeRequest(HttpRequestMethods.GET, endpoint, postUrl);
    // }
